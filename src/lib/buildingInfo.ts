...
const buildingNames: { [key: string]: string } = {
  ...
  SSA: 'SSA (Student Services Addition)',
  SU: 'SU (Student Union)',
...
export const mapLinkOverrides: {
  ...
  'https://locator.utdallas.edu/SSA_Gaming Wall Lounge':
    'https://locator.utdallas.edu/SSA_12.120',
  'https://locator.utdallas.edu/SU_Galaxy  Room  (A & B)':
    'https://locator.utdallas.edu/SU_2.602',
  'https://locator.utdallas.edu/SU_Galaxy  Room  (A, B, & C)':
    'https://locator.utdallas.edu/SU_2.602',
  'https://locator.utdallas.edu/SU_Galaxy  Room  (B & C)':
    'https://locator.utdallas.edu/SU_2.602',
  'https://locator.utdallas.edu/SU_Galaxy  Room - A':
    'https://locator.utdallas.edu/SU_2.602',
  'https://locator.utdallas.edu/SU_Galaxy  Room - B':
    'https://locator.utdallas.edu/SU_2.602',
  'https://locator.utdallas.edu/SU_Galaxy  Room - C':
    'https://locator.utdallas.edu/SU_2.602',
  'https://locator.utdallas.edu/SU_Lower Level Booth 1':
    'https://map.concept3d.com/?id=1772#!m/435268',
  'https://locator.utdallas.edu/SU_Lower Level Booth 2':
    'https://map.concept3d.com/?id=1772#!m/435268',
  'https://locator.utdallas.edu/SU_Lower Level Booth 3':
    'https://map.concept3d.com/?id=1772#!m/435268',
  'https://locator.utdallas.edu/SU_Artemis Hall (I & II)':
    'https://locator.utdallas.edu/SU_2.905A',
  'https://locator.utdallas.edu/SU_Artemis Hall I':
    'https://locator.utdallas.edu/SU_2.905A',
  'https://locator.utdallas.edu/SU_Artemis Hall II':
    'https://locator.utdallas.edu/SU_2.905B',
  'https://locator.utdallas.edu/SU_First Floor':
    'https://map.concept3d.com/?id=1772#!m/545124',
  'https://locator.utdallas.edu/SU_Upper Level Booth 1':
    'https://map.concept3d.com/?id=1772#!m/545124',
  'https://locator.utdallas.edu/SU_Upper Level Booth 2':
    'https://map.concept3d.com/?id=1772#!m/545124',
  'https://locator.utdallas.edu/SU_Upper Level Booth 3':
    'https://map.concept3d.com/?id=1772#!m/545124',
  'https://locator.utdallas.edu/SU_Upper Level Booth 4':
    'https://map.concept3d.com/?id=1772#!m/545124',
